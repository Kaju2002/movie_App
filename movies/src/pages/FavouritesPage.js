    ...
    >
      <Container maxWidth="xl">
        ...
        {favorites.length > 0 ? (
          <>
            ...
            >
              ...
              <FormControl variant="standard" sx={{ m: 0, minWidth: 150 }}>
                ...
                >
                  <MenuItem value="date_added" sx={{ fontSize: "0.9rem" }}>
                    Added
                  </MenuItem>
                  <MenuItem value="alphabetical" sx={{ fontSize: "0.9rem" }}>
                    A-Z
                  </MenuItem>
                  <MenuItem value="rating" sx={{ fontSize: "0.9rem" }}>
                    Rating
                  </MenuItem>
                  <MenuItem value="release_date" sx={{ fontSize: "0.9rem" }}>
                    Release
                  </MenuItem>
                </Select>
              </FormControl>
          ...
          >
            <FavoriteIcon
              sx={{ fontSize: 70, color: "text.disabled", mb: 3 }}
            />
            <Typography
              variant="h4"
              component="h2"
            ...
            >
              Looks like your favorites list is empty. Start exploring and add
              movies you love!
            </Typography>
            <Button
